...
'''
This function requires a url as parameter (listed above), and returns a dictionary of movie information (except for superhero):
    title: str
    poster: str
    time: str
    certificate: str
...
def fetch_imdb(url, table_name):
    ...
    for movie in movie_list:
        ...
        try:
            ...
            genre = np.nan
        try:
            rate = float(movie.find('div','inline-block ratings-imdb-rating').text.strip()) # movie rate (out of 10)
        except:
            rate = np.nan        
...
'''
This function requires a url as parameter (listed above), and returns a dictionary of superhero movie information:
    title: str
    poster: str
    time: str
    certificate: str
